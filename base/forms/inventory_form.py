...
from django.forms import (
    FileInput, NumberInput, Select, SelectMultiple, Textarea, TextInput
)
...
class InventoryForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'finish': Select(attrs={'class': 'form-control select2', 'id': 'finish'}),
            'size': Select(attrs={'class': 'form-control select2', 'id': 'size'}),
